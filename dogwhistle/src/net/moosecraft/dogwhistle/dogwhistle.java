...
public final class dogwhistle extends JavaPlugin implements Listener{
    ...
    public void onInteract(PlayerInteractEvent event) {
    	...
    	Integer radiusX = Integer.valueOf(this.getConfig().getString("radiusX"));
    	Integer radiusY = Integer.valueOf(this.getConfig().getString("radiusY"));
    	Integer radiusZ = Integer.valueOf(this.getConfig().getString("radiusZ"));
    	Boolean dogEnabled = Boolean.valueOf(this.getConfig().getString("dogs enabled"));
    	Boolean catEnabled = Boolean.valueOf(this.getConfig().getString("cats enabled"));
